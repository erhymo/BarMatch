...
const LEAGUES: LeagueKey[] = ["EPL", "ENG_CHAMPIONSHIP", "FA_CUP", "EFL_TROPHY", "NOR_ELITESERIEN", "SERIE_A", "COPA_DEL_REY", "BUNDESLIGA", "UCL", "UEL"];
...
export function useKamperFixtures() {
  const [fixturesByLeague, setFixturesByLeague] = useState<Record<LeagueKey, Fixture[]>>({
    EPL: [], ENG_CHAMPIONSHIP: [], FA_CUP: [], EFL_TROPHY: [], NOR_ELITESERIEN: [], SERIE_A: [], COPA_DEL_REY: [], BUNDESLIGA: [], UCL: [], UEL: [],
  });
  ...
  useEffect(() => {
    ...
    async function loadAll() {
      ...
      try {
        ...
        const byLeague: Record<LeagueKey, Fixture[]> = { EPL: [], ENG_CHAMPIONSHIP: [], FA_CUP: [], EFL_TROPHY: [], NOR_ELITESERIEN: [], SERIE_A: [], COPA_DEL_REY: [], BUNDESLIGA: [], UCL: [], UEL: [] };
