...
export function useKamperFixtures() {
  const [fixturesByLeague, setFixturesByLeague] = useState<Record<LeagueKey, Fixture[]>>({
    EPL: [], ENG_CHAMPIONSHIP: [], FA_CUP: [], NOR_ELITESERIEN: [], SERIE_A: [], UCL: [], UEL: [],
  });
  ...
  useEffect(() => {
    ...
    async function loadAll() {
      ...
      try {
        ...
        const byLeague: Record<LeagueKey, Fixture[]> = { EPL: [], ENG_CHAMPIONSHIP: [], FA_CUP: [], NOR_ELITESERIEN: [], SERIE_A: [], UCL: [], UEL: [] };
