...
const LEAGUES: LeagueKey[] = ["EPL", "ENG_CHAMPIONSHIP", "FA_CUP", "EFL_TROPHY", "NOR_ELITESERIEN", "NOR_1_DIVISION", "SERIE_A", "COPA_DEL_REY", "BUNDESLIGA", "LIGUE_1", "UCL", "UEL", "FIFA_CWC", "FIFA_CWC_PLAYIN", "UEFA_NL", "FRIENDLIES"];
...
export function useKamperFixtures() {
  const [fixturesByLeague, setFixturesByLeague] = useState<Record<LeagueKey, Fixture[]>>({
    EPL: [], ENG_CHAMPIONSHIP: [], FA_CUP: [], EFL_TROPHY: [], NOR_ELITESERIEN: [], NOR_1_DIVISION: [], SERIE_A: [], COPA_DEL_REY: [], BUNDESLIGA: [], LIGUE_1: [], UCL: [], UEL: [], FIFA_CWC: [], FIFA_CWC_PLAYIN: [], UEFA_NL: [], FRIENDLIES: [],
  });
  ...
  useEffect(() => {
    ...
    async function loadAll() {
      ...
      try {
        ...
        const byLeague: Record<LeagueKey, Fixture[]> = { EPL: [], ENG_CHAMPIONSHIP: [], FA_CUP: [], EFL_TROPHY: [], NOR_ELITESERIEN: [], NOR_1_DIVISION: [], SERIE_A: [], COPA_DEL_REY: [], BUNDESLIGA: [], LIGUE_1: [], UCL: [], UEL: [], FIFA_CWC: [], FIFA_CWC_PLAYIN: [], UEFA_NL: [], FRIENDLIES: [] };
