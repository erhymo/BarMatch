...
const LEAGUES: LeagueKey[] = ["EPL", "ENG_CHAMPIONSHIP", "FA_CUP", "EFL_TROPHY", "NOR_ELITESERIEN", "NOR_1_DIVISION", "SERIE_A", "COPA_DEL_REY", "BUNDESLIGA", "LIGUE_1", "UCL", "UEL", "FIFA_CWC"];
...
export function useKamperFixtures() {
  const [fixturesByLeague, setFixturesByLeague] = useState<Record<LeagueKey, Fixture[]>>({
    EPL: [], ENG_CHAMPIONSHIP: [], FA_CUP: [], EFL_TROPHY: [], NOR_ELITESERIEN: [], NOR_1_DIVISION: [], SERIE_A: [], COPA_DEL_REY: [], BUNDESLIGA: [], LIGUE_1: [], UCL: [], UEL: [], FIFA_CWC: [],
  });
  ...
  useEffect(() => {
    ...
    async function loadAll() {
      ...
      try {
        ...
        const byLeague: Record<LeagueKey, Fixture[]> = { EPL: [], ENG_CHAMPIONSHIP: [], FA_CUP: [], EFL_TROPHY: [], NOR_ELITESERIEN: [], NOR_1_DIVISION: [], SERIE_A: [], COPA_DEL_REY: [], BUNDESLIGA: [], LIGUE_1: [], UCL: [], UEL: [], FIFA_CWC: [] };
