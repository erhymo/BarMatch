...
export const translations = {
  no: {
    ...
    map_geo_denied: 'Du må gi tillatelse til posisjonsdeling',
    map_geo_denied_tap: 'Trykk her for å prøve igjen',
    map_geo_denied_retrying: 'Prøver på nytt...',
    map_geo_denied_help: 'Hvis det ikke fungerer: Innstillinger → Personvern og sikkerhet → Stedstjenester → Safari / Where2Watch → Tillat posisjon.',
  ...
  en: {
    ...
    map_geo_denied: 'You must allow location access',
    map_geo_denied_tap: 'Tap here to try again',
    map_geo_denied_retrying: 'Retrying...',
    map_geo_denied_help: 'If it doesn\'t work: Settings → Privacy & Security → Location Services → Safari / Where2Watch → Allow location.',
