...
export const translations = {
  no: {
    ...
    map_geo_denied: 'Åpne innstillinger for å dele posisjon slik at du utnytter appen best.',
    map_geo_denied_tap: 'Trykk her for å prøve igjen',
    map_geo_denied_retrying: 'Prøver på nytt...',
    map_geo_denied_help: 'Innstillinger → Personvern og sikkerhet → Stedstjenester → Safari / Where2Watch → Tillat posisjon.',
    map_geo_open_settings: 'Åpne innstillinger',
  ...
  en: {
    ...
    map_geo_denied: 'Open settings to share your location and get the most out of the app.',
    map_geo_denied_tap: 'Tap here to try again',
    map_geo_denied_retrying: 'Retrying...',
    map_geo_denied_help: 'Settings → Privacy & Security → Location Services → Safari / Where2Watch → Allow location.',
    map_geo_open_settings: 'Open Settings',
