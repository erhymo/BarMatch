...
export default function SportFilterPanel({
  ...
  const addRecentFromTeamSuggestion = useCallback(
    (suggestion: TeamSuggestion) => {
      // Viktig: bygg og lagre neste liste *i selve klikket*, slik at vi
      // ikke er avhengige av at React prosesserer en state-oppdatering
      // før panelet rekker å bli lukket/unmountet.
